...
export default function FarmerProductUpdateForm(data: any) {
  ...
  const handleSubmit = async (formData: FormData) => {
    try {
      ...
      router.refresh
      router.push(`/profile/farmer/${data.id}`);
    } catch (error) {
      ...
      <form ref={ref} action={handleSubmit}>
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 p-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
